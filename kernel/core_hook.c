...
out_ksu_try_umount:
	...
	try_umount("/apex/com.android.art/bin/dex2oat64", true, MNT_DETACH, uid);
	try_umount("/apex/com.android.art/bin/dex2oat32", true, MNT_DETACH, uid);
	
		// try umount zygisk detach
	try_umount("/system/bin/detach", true, MNT_DETACH);
#endif
